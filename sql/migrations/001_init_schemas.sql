...
-- Migration: 001_init_schemas.sql
-- Run via: psql $DATABASE_URL -f sql/migrations/001_init_schemas.sql
...
-- ============================================================
-- RAW — 2. Открытые данные Казахстана
-- ============================================================
...
-- ============================================================
-- RAW — 3. Web Scraping: Tengrinews.kz
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_tengri_published
    ON raw.tengri_news (published_at DESC);
...
-- ============================================================
-- STAGING — очищенные данные
-- Используем DROP + CREATE для идемпотентности
-- ============================================================

DROP TABLE IF EXISTS staging.crypto_prices;
CREATE TABLE staging.crypto_prices AS
SELECT
    coin_id,
    coin_name,
...
DROP TABLE IF EXISTS staging.forex_rates;
CREATE TABLE staging.forex_rates AS
SELECT
    rate_date,
    currency_code,
    currency_name,
...
CREATE OR REPLACE VIEW mart.news_by_category AS
SELECT
